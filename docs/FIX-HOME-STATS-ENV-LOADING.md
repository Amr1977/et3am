...
```
DATABASE_URL=postgresql://neondb_owner:npg_XveTDxw5HRJ7@ep-nameless-scene-anwafvan-pooler.c-6.us-east-1.aws.neon.tech/neondb?sslmode=require
NODE_ENV=production
...
**`.env`** (Default/Test):
```
DATABASE_URL=postgresql://neondb_owner:npg_XveTDxw5HRJ7@ep-flat-mountain-an8hva6r-pooler.c-6.us-east-1.aws.neon.tech/neondb?sslmode=require
