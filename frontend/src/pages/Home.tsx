    ...
    <div className="home-page">
      ...
      <section className="support-dev-section">
        <div className="support-dev-container">
          ...
          <h2 className="support-dev-title">Support Our Mission</h2>
          <p className="support-dev-desc">
            Your generous contributions help us continue developing features that connect more people with surplus food to those in need.
          </p>
          
          <div className="support-dev-cards">
            <div className="support-method-card">
              ...
              <span className="method-number">01094450141</span>
            ...
            <div className="support-method-card">
              ...
              <span className="method-name">Vodafone Cash</span>
              <span className="method-number">01094450141</span>
              <button className="copy-btn" onClick={() => navigator.clipboard.writeText('01094450141')}>
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                  <rect x="9" y="9" width="13" height="13" rx="2"/>
          ...
          <p className="support-dev-thanks">JazakAllah Khair for your support! 🤲</p>
        </div>
      </section>
