...
- Name: user-authentication.e2e.ts >> User Authentication >> should show error for missing fields on register
- Location: tests\e2e\user-authentication.e2e.ts:24:3
...
Locator: locator('text=Required field')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('text=Required field')
      ...
      - generic [ref=e34]:
        ...
        - generic [ref=e47]:
          - generic [ref=e48]:
            ...
            - textbox "الاسم الكامل" [active] [ref=e50]:
