...
- Name: user-authentication.e2e.ts >> User Authentication >> should show language toggle
- Location: tests\e2e\user-authentication.e2e.ts:59:3
...
Call log:
  ...
  - waiting for locator('text=العربية')
