...
- Name: user-authentication.e2e.ts >> User Authentication >> should successfully login with valid credentials
- Location: tests\e2e\user-authentication.e2e.ts:30:3
  ...
  - generic [ref=e3]:
    ...
    - main [ref=e31]:
      - generic [ref=e34]:
        ...
        - button "دخول باستخدام Google" [disabled] [ref=e39]:
          - img [ref=e40]
        ...
        - paragraph [ref=e58]:
          - text: ليس لديك حساب؟
          - link "سجل الآن" [ref=e59] [cursor=pointer]:
            - /url: /register
    - contentinfo [ref=e60]:
      - generic [ref=e61]:
        - generic [ref=e62]:
          - generic [ref=e63]: 🤲
          - generic [ref=e64]: إطعام
          - paragraph [ref=e65]: منصة خيرية لتوصيل الطعام الفائض للمحتاجين
        - link "🌐 et3am.com" [ref=e67] [cursor=pointer]:
          - /url: https://et3am.com
        - paragraph [ref=e69]: © 2025 إطعام. All rights reserved.
    - generic [ref=e70]: Signing in...
  - paragraph [ref=e71]: Running in emulator mode. Do not use with production credentials.
```
