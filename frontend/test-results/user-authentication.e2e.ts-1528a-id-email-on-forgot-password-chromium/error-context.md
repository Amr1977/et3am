...
- Name: user-authentication.e2e.ts >> User Authentication >> should show error for invalid email on forgot password
- Location: tests\e2e\user-authentication.e2e.ts:89:3
